...
name_u = 'elastic_error_disp_u_peers_trapezioidal_1b.txt';
name_r = 'elastic_error_rot_u_peers_trapezoidal_1b.txt';
name_div = 'elastic_error_div_u_peers_trapezoidal_1b.txt';
...
for i=1:size(nl,2)
    ...
    er_u = error_l2_norm(spost, element, coordinates);  
