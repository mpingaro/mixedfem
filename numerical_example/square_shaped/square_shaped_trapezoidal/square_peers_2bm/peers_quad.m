...
name_u = 'elastic_error_disp_u_peers_trapezioidal_2bm.txt';
name_r = 'elastic_error_rot_u_peers_trapezoidal_2bm.txt';
name_div = 'elastic_error_div_u_peers_trapezoidal_2bm.txt';
