...
\begin{tikzpicture}
 ...
 {figure/cook/cook_random_peers_ver1.txt};
 \addlegendentry{PEERS \textbf{2B} (mixed)}
 %
 \addplot[blue, mark=x, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_random_peers_ver2.txt};
 \addlegendentry{PEERS \textbf{2B}}
 %
 \addplot[green3, mark=o, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_random_peers_ver3_ver1.txt};
 \addlegendentry{PEERS \textbf{1B} (version 1)}
 %
 \addplot[green3, mark=o, thick, dashed, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_random_peers_ver3_ver2.txt};
 \addlegendentry{PEERS \textbf{1B} (version 2)}
 % 
 \end{axis}
\end{tikzpicture}
%\end{center}
