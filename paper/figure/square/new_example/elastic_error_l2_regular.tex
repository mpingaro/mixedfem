...
\begin{tikzpicture}
 ...
 {figure/square/new_example/results/elastic_error_disp_u_peers_1b.txt};
 \addlegendentry{PEERSQ1B}
 %
 \addplot[red, mark=x, very thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/square/new_example/results/elastic_error_disp_u_peers_2b.txt};
 \addlegendentry{PEERSQ2B}
 %
 \addplot[blue, mark=o, very thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/square/new_example/results/elastic_error_disp_u_peers_2bm.txt};
 \addlegendentry{PEERSQ2BM}
 %
 \addplot[black, mark=square, very thick]
 table [x index={0}, y index={1}]
 {figure/square/new_example/results/elastic_error_disp_u_peersq.txt};
