...
name_u   = 'elastic_error_disp_u_peersq_trapezoidal.txt';
name_r   = 'elastic_error_rot_u_peersq_trapezoidal.txt';
name_div = 'elastic_error_div_u_peersq_trapezoidal.txt';
