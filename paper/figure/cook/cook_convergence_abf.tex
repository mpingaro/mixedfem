...
\begin{tikzpicture}
 ...
 {figure/cook/cook_regular_abf_2b.txt};
 \addlegendentry{ABFQ2B} 
 %
 \addplot[blue, mark=o, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_regular_abf_2bm.txt};
 \addlegendentry{ABFQ2BM}
 %
 \addplot[green, mark=triangle, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_regular_abf_1b_v1.txt};
 \addlegendentry{ABFQ1B (v.1)}
% %
 \addplot[green3, mark=o, thick, dashed, mark options={solid}]
 table [x index={0}, y index={1}]
 {figure/cook/cook_regular_abf_1b_v2.txt};
 \addlegendentry{ABFQ1B (v.2)}
 % 
 \end{axis}
\end{tikzpicture}
%\end{center}
